...
const SidebarComponent = ({ isCollapsed, onToggle, onSearchClick }: SidebarProps) => {
    ...
    const bottomItems = useMemo(
        () => [
            ...
            {
                href: 'https://www.dropbox.com/scl/fi/esk4h8z45sryvbremy57v/Cidekick_latest.dmg?rlkey=92y535bz6p6gov6vd17x6q53b&st=9kl0annj&dl=1',
                icon: '/download.svg',
                text: 'Download Cidekick Camera',
                ariaLabel: 'Download Cidekick Camera (new window)',
            },
            {
                href: 'https://www.dropbox.com/scl/fi/znid09apxiwtwvxer6oc9/Cidekick_latest.dmg?rlkey=gwvvyb3bizkl25frhs4k1zwds&st=37q31b4w&dl=1',
                icon: '/download.svg',
                text: 'Download Cidekick',
                ariaLabel: 'Download Cidekick (new window)',
            },
        ],
        []
    );
                ...
                {!isCollapsed && hasApiKey !== null && (
                    <div className="px-2.5 py-2 text-center">
                        <span className={`text-xs px-2 py-1 rounded-full ${hasApiKey ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'}`}>
                            {hasApiKey ? 'Local running' : 'Cidekick Free System'}
                        </span>
                    </div>
                )}
